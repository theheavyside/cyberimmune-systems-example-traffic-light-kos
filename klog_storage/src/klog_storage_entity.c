...
int main(int argc, char *argv[])
{
    ...
    return klog_storage_run(KLOG_STORAGE_SERVER_CONNECTION_ID, traffic_light_KlogStorageEntity_klogStorage_iidOffset, traffic_light_KlogStorageEntity_klogStorage_storage_iid, comp);
}
